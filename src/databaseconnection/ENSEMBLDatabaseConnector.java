...
public class ENSEMBLDatabaseConnector {
    ...
    public ENSEMBLDatabaseConnector(final String database) throws Exception {
        this.sql2o = new Sql2o(database, "anonymous", "");
        getIDToENSGDB();
    }
    ...
    private List<Query> getUniprotQueries() throws Exception {
        ...
        try (Connection con = sql2o.open()) {
            ...
            System.out.println("The ensembl databases are not responding (correctly).\n"
                    + "Please check the database you have given. It should look like:\n"
                    + "ensembldb.ensembl.org:5306/homo_sapiens_core_83_38\nPlease do not put "
                    + "jdbc:mysql:// in front of the database name.\n"
                    + "Please make sure there is no maintenance or anything going on with the\n"
                    + "server of ensembl.\n"
